...
if ($version ne "x.xx.xx.xx")
{
  ...
  `/usr/local/java/bin/java -Djava.ext.dirs=/var/www/html/software_common/lib scri.commons.utils.AppTracker -appname=strudel -live="$date\t$ip\t$id\t$version\t$locale\t$rating\t$os\t$user"`;
}
